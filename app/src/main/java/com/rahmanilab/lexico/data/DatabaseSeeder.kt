package com.rahmanilab.lexico.data
...
/**
 * Populates a small "Getting Started" deck the first time the app runs so the UI is never empty.
 * Guarded by a DataStore flag, and additionally only seeds when the database is genuinely empty.
 */
class DatabaseSeeder(
    ...
    suspend fun seedIfNeeded() {
        ...
        val deckId = deckRepository.createDeck(
            ...
            description = "A few example cards to explore Lexico."
        )
